...
mkdir NOCSM/
mkdir NOCSM/9.1.24-SE
mkdir NOCSM/9.1.24-NSE
mkdir NOCSM/10.3.7-SE
mkdir NOCSM/10.3.7-NSE
...
then
    ...
    cp out/arch/arm64/boot/Image.gz-dtb NOCSM/9.1.24-SE/Image.gz-dtb
    ...
    then
        ...
        echo "Build succesful"
        cp out/arch/arm64/boot/Image.gz-dtb NOCSM/9.1.24-NSE/Image.gz-dtb
        ...
        then
            ...
            echo "Build succesful"
            cp out/arch/arm64/boot/Image.gz-dtb NOCSM/10.3.7-SE/Image.gz-dtb
            ...
            then
                ...
                echo "Build succesful"
                cp out/arch/arm64/boot/Image.gz-dtb NOCSM/10.3.7-NSE/Image.gz-dtb
